...
if __name__ == "__main__":
    ...
    for i in range(1, s):
        ...
        if opt[i-1] =='None':
            opt[i - 1] = None
    folder = r"C:\Users\matteo.demarco\Downloads\M189_PVP251_FDCAN11_FDCAN3_FDCAN5_OMOLOGAZIONE_COAST_DOWN_MDF"
...
file_listaCanali.write(f'name\tunit\t description\tmastr\tlen\tid\n')
errori = dict()
